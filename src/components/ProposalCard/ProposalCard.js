...
const ProposalCard = ({ proposal }) => {
  ...
  return (
    <div className="border-b last:border-0 border-gray-400 flex-col hover:bg-gray-50 bg-[#f2f2f2] rounded-md p-4">
      ...
      <p className="text-sm text-lead">{proposal?.description}</p>
