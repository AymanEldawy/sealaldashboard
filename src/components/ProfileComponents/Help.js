...
import { BanIcon, CardFlatIcon, DollarIcon, MessageFlatIcon, TagIcon, TrunkFlatIcon } from '../Icons';
...
export const Help = () => {
  ...
  return (
    <div className="">
      <ProfileTitle title={fetchWord('Help', lang)} />
      <div className="grid gap-4 md:gird-cols-2">
        {faqs?.map((question) => (
