    ...
    <form onSubmit={handleSubmit(onSubmit)} className='pt-6 px-4 pb-4 bg-white rounded-b-xl'>
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
        <div className='flex items-center gap-2 overflow-hidden'>
          <input className='text-sm min-w-auto w-auto max-w-full border flex-1 border-[#D5D9E1] rounded-md p-2' placeholder={fetchWord('Status', lang)} {...register("status", { required: true, maxLength: 20 })} />
        ...
        <div className='flex items-center gap-2 overflow-hidden'>
          ...
          <input className='text-sm min-w-auto w-auto max-w-full border flex-1 border-[#D5D9E1] rounded-md p-2' type="datetime-local" placeholder={fetchWord('Starting_date', lang)} {...register("starting_date", { required: true, maxLength: 20 })} />
        </div>
        <div className='flex items-center gap-2 overflow-hidden'>
          <input className='text-sm min-w-auto w-auto max-w-full border flex-1 border-[#D5D9E1] rounded-md p-2' type="datetime-local" placeholder={fetchWord('End_Date', lang)} {...register("end_date", { required: true, maxLength: 20 })} />
        </div>
